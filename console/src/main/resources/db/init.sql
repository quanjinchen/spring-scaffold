...
insert into sys_menu (
    ...
    (3, 1, '用户管理', '/system/user', 'MENU', 'system:user:query', 20, 1, 1, now(), 1, now(), 0),
    (4, 1, '角色管理', '/system/role', 'MENU', 'system:role:query', 30, 1, 1, now(), 1, now(), 0),
    (5, 1, '组织管理', '/system/org', 'MENU', 'system:org:query', 40, 1, 1, now(), 1, now(), 0),
    ...
    (10, 3, '用户保存', '/system/user/save', 'BUTTON', 'system:user:update', 90, 1, 1, now(), 1, now(), 0),
    (11, 3, '重置密码', '/system/user/reset-password', 'BUTTON', 'system:user:resetPassword', 100, 1, 1, now(), 1, now(), 0),
    (12, 4, '角色保存', '/system/role/save', 'BUTTON', 'system:role:update', 110, 1, 1, now(), 1, now(), 0),
    (13, 5, '组织保存', '/system/org/save', 'BUTTON', 'system:org:update', 120, 1, 1, now(), 1, now(), 0),
