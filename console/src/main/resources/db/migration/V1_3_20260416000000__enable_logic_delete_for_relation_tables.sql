...
set @sys_user_role_row_num = 0;
update sys_user_role
set id = (@sys_user_role_row_num := @sys_user_role_row_num + 1)
where id is null;
...
set @sys_org_user_row_num = 0;
update sys_org_user
set id = (@sys_org_user_row_num := @sys_org_user_row_num + 1)
where id is null;
...
set @sys_role_menu_row_num = 0;
update sys_role_menu
set id = (@sys_role_menu_row_num := @sys_role_menu_row_num + 1)
where id is null;
